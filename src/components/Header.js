...
const Header = () => {
  ...
  return (
    <div className='flex justify-between py-3 px-4 sticky top-0 z-10 bg-white h-12 dark:bg-[#0f0f0f] dark:text-white'>
      <div className='flex gap-4 items-center justify-start w-56' >
        <MenuIcon onClick={() => dispatch(toggleSideBar())} />
        <Link to={"/"} ><img className='h-5' src={isDarkMode ? "https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/YouTube_dark_logo_2017.svg/1280px-YouTube_dark_logo_2017.svg.png" : "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/YouTube_Logo_2017.svg/2560px-YouTube_Logo_2017.svg.png"} alt="" /></Link>
      </div>
      <div ref={inputBox} >
        <div className='flex items-center justify-between'>
          <div className='flex'>
            <input
              ...
              className='border border-gray-400 rounded-l-full p-1 px-4 w-[30rem] dark:bg-[#0f0f0f]'
              type="text"
              placeholder='search...'
          ...
          <button className='bg-slate-100 p-1 rounded-full border border-gray-400 ml-4 dark:bg-[#222222]' ><MicIcon /></button>
        </div>
        {(isSuggestionsVisible && suggestions.length != 0) &&
          <div className='px-4 p-1 shadow-md rounded-lg w-[30rem] bg-white dark:bg-[#222222]' >
            {
